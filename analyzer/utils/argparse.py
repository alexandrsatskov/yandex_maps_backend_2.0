...
def clear_environ(rule: Callable):
    ...
    переменные для очистки определяет
    переданная функция rule.
    """
    # Ключи из os.environ копируются в новый tuple,
    # чтобы не менять объект os.environ во время итерации.
